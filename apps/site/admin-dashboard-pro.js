(()=>{
  if(!document.querySelector('link[data-admin-v5-polish]')){
    ...
    link.rel='stylesheet';
    link.href='./admin-v5-polish.css?v=20260821-polish3';
  ...
  if(oldRenderStats) renderStats=function(){
    oldRenderStats();
  ...
  // IMPORTANTE: observar apenas a abertura/fechamento do dashboard.
  // A versão anterior também observava childList/subtree e o próprio
  // renderDashboardExtras alterava esses nós, criando um loop infinito.
