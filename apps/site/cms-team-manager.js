(()=>{
  ...
  function card(m){return `<article class="cms-team-card" data-team-id="${E(m.id)}">
    ...
    <div class="cms-team-grid">
      ...
      <label class="cms-team-label wide"><span>Foto real</span><div class="cms-team-media"><input data-team-field="photo_url" type="url" value="${E(m.photo_url||'')}" placeholder="URL da foto"><button class="cms-team-upload" type="button" data-upload="photo_url">🖼️ Escolher foto</button></div></label>
      <label class="cms-team-label wide"><span>Bonequinho / personagem</span><div class="cms-team-media"><input data-team-field="mascot_url" type="url" value="${E(m.mascot_url||'')}" placeholder="Imagem do bonequinho que aparece à direita"><button class="cms-team-upload" type="button" data-upload="mascot_url">🎭 Escolher bonequinho</button></div></label>
    </div>
