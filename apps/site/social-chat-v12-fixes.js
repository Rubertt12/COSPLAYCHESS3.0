(() => {
  ...
  loadCss('./social-chat-v20.css?v=20260901-1','ccChatV20Css');
  loadScript('./social-chat-v20.js?v=20260901-1','ccChatV20Js');

  // Notificações: popover das 3 mais recentes + central clicável.
  loadCss('./social-notifications-v22.css?v=20260901-1','ccNotificationsV22Css');
  loadScript('./social-notifications-v22.js?v=20260901-1','ccNotificationsV22Js');

  // Modal de fotos: curtir, comentar e compartilhar no feed.
  loadCss('./social-photo-actions-v21.css?v=20260901-1','ccPhotoActionsV21Css');
  loadScript('./social-photo-actions-v21.js?v=20260901-1','ccPhotoActionsV21Js');
